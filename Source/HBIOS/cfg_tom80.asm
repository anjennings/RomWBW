;
;==================================================================================================
;   ROMWBW 2.X CONFIGURATION DEFAULTS FOR Tom80
;==================================================================================================
;
...
; FOR THE PLATFORM.
;
#DEFINE PLATFORM_NAME "TOM80"
;
PLATFORM	.EQU	PLT_TOM80	; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RCZ80|RCZ180|EZZ80|SCZ180|DYNO]
...
;
Z180_BASE	.EQU	$00		; Z180: I/O BASE ADDRESS FOR INTERNAL REGISTERS
Z180_CLKDIV	.EQU	1		; Z180: CHK DIV: 0=OSC/2, 1=OSC, 2=OSC*2
Z180_MEMWAIT	.EQU	3		; Z180: MEMORY WAIT STATES (0-3)
...
DIAGDISKIO	.EQU	FALSE		; ENABLES DISK I/O ACTIVITY ON DIAGNOSTIC LEDS
;
...
SIOCNT		.EQU	0		; SIO: NUMBER OF CHIPS TO DETECT (1-2), 2 CHANNELS PER CHIP
...
;
RFENABLE	.EQU	TRUE		; RF: ENABLE RAM FLOPPY DRIVER
;
...
SDMODE		.EQU	SDMODE_PIO	; SD: DRIVER MODE: SDMODE_[JUHA|N8|CSIO|PPI|UART|DSD|MK4|SC|MT]
