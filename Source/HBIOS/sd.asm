...
SD_PIOBASE	.EQU	0				; BASE IO PORT FOR PPI
SD_DEVMAX	.EQU	1		; NUMBER OF PHYSICAL UNITS (SOCKETS)
SD_PIOAD		.EQU	SDPIOBASE 		; PPI PORT A DATA 	
SD_PIOAC		.EQU	SDPIOBASE + 1	; PPI PORT A CONTROL 
SD_PIOBD		.EQU	SDPIOBASE + 2	; PPI PORT B DATA
SD_PIOBC		.EQU	SDPIOBASE + 3	; PPI PORT B Control
SD_OPRREG	.EQU	SD_PIOAD		; PPI PORT C IS OPR REG
SD_OPRDEF	.EQU	%01111101	; CS HI, DI HI
SD_INPREG	.EQU	SD_PIOAD	; INPUT REGISTER IS PPI PORT B
