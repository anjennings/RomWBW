...
#ENDIF
;
#IF (SDMODE == SDMODE_TOM80)		; Tom80 PIO SD
SD_PIOBASE	.EQU	$80				; BASE IO PORT FOR PIO
SD_DEVMAX	.EQU	1				; NUMBER OF PHYSICAL UNITS (SOCKETS)
SD_PIOAD	.EQU	SD_PIOBASE 		; PPI PORT A DATA
SD_PIOBD	.EQU	SD_PIOBASE + 1	; PPI PORT B DATA
SD_PIOAC	.EQU	SD_PIOBASE + 2	; PPI PORT A CONTROL 
SD_PIOBC	.EQU	SD_PIOBASE + 3	; PPI PORT B Control
SD_OPRREG	.EQU	SD_PIOAD		; PPI PORT C IS OPR REG
SD_OPRDEF	.EQU	%01111101		; CS HI, DI HI
SD_INPREG	.EQU	SD_PIOAD		; INPUT REGISTER IS PIO PORT A
SD_CS0		.EQU	%00000100		; PIOA:2 IS SELECT
SD_CLK		.EQU	%00000010		; PIOA:1 IS CLOCK
SD_DI		.EQU	%00000001		; PIOA:0 IS DATA IN (CARD <- CPU)
SD_DO		.EQU	%10000000		; PIOA:7 IS DATA OUT (CARD -> CPU)
SD_IOBASE	.EQU	SD_PIOBASE		; IOBASE
#ENDIF
;
...
SD_SETUP:
;
TOM80_MODESET	.EQU	$CF	; Mode 3
TOM80_IOCONSET	.EQU	$01	; LSB is input
TOM80_INTDIS	.EQU	$07	; Disable Int

#IF (SDMODE == SDMODE_TOM80)
	; Z84C20, PORT A, Mode 3
	; Assume that it has not been initilized anywhere else
	LD A, TOM80_MODESET
	OUT (SD_PIOAC), A	; Set MODE
	
	LD A, TOM80_IOCONSET
	OUT (SD_PIOAC), A	; Set IO Controls
...
#IF ((SDMODE == SDMODE_PPI) | (SDMODE == SDMODE_UART) | (SDMODE == SDMODE_SC) | (SDMODE == SDMODE_TOM80))
